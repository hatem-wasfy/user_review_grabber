...
file_name2 = "by_no_name.csv"


with open(file_name2, "a+") as toWrite:    
    writer=csv.writer(toWrite, quoting = csv.QUOTE_NONE)
    ...
    with open(file_name) as f:
            ...
            for row in content:
                ...
                try:
                    ...
                    #in case of dealing with the by name file so i need row[3] the review text to be checked if not english
                    ###langu = detect(row[3])
